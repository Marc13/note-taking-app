...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "account" | "session" | "user" | "verificationToken" | "note" | "category" | "tag" | "noteTags"
  ...
  export type CategoryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "color" | "createdAt" | "updatedAt" | "userId", ExtArgs["result"]["category"]>
  ...
  export type NoteTagsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "noteId" | "tagId", ExtArgs["result"]["noteTags"]>
  ...
  export interface NoteTagsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `id`
     * const noteTagsWithIdOnly = await prisma.noteTags.findMany({ select: { id: true } })
     * 
     */
     ...
     * const noteTagsWithIdOnly = await prisma.noteTags.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const noteTagsWithIdOnly = await prisma.noteTags.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface NoteTagsFieldRefs {
    readonly id: FieldRef<"NoteTags", 'String'>
  ...
  export type NoteTagsWhereInput = {
    ...
    id?: StringFilter<"NoteTags"> | string
  ...
  export type NoteTagsScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"NoteTags"> | string
