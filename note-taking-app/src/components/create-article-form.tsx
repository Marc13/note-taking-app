...
/**
 * Props for the CreateArticleForm component
 */
 ...
 * 
 * Client-side form for creating new knowledge base articles with
 * validation, loading states, and error handling.
 */
export function CreateArticleForm({ categories, action }: CreateArticleFormProps) {
